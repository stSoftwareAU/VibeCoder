...
| **[Provider parity](docs/PROVIDER-PARITY.md)**                                 | Shared quota scheduler, scoped usage pauses, multiple Codex credentials, opt-in fallback, and the staged Codex rollout / rollback runbook |
