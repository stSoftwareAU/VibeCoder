...
| **[Prompt best-practices checklist](docs/PROMPT-BEST-PRACTICES-CHECKLIST.md)** | The shared rubric for auditing a prompt surface against Anthropic's Claude prompting best-practices guide: 22 checklist rows, verdict table, gap-issue template |
...
| **[Documentation-Audit Scans](docs/DOCUMENTATION-AUDIT-SCAN.md)**              | Operator manual for the prose-documentation audit: unify PR-summary learnings into the README, prune stale docs, the twelve checks, labels, suppression |
