...
| Label                   | Default               | Config Key                  | Description                                                                                                                                 |
| ----------------------- | --------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **Failed once**         | `failed-once`         | `failed_once_label`         | Applied after the first non-transient processing failure — coding, planning and question runs alike (Issue #1949). The issue is unassigned and automatically retried on the next scan. Transient infrastructure (rate/usage limit, out of credit, interruption, scheduled release, deadline-bound timeout) consumes no attempt. |
