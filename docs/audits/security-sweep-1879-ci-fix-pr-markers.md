...
after chunk 12ab recorded its coverage:
...
swept `collectFleetCiFixMarkers` (12aa, #1877), and renders the result as the
...
- **A fleet account can still write a marker by hand**, and a fleet credential
  therefore spends the pull request's budget. Inherited from 12aa: author
