...
**Issue:** [#2098](https://github.com/stSoftwareAU/VibeCoder/issues/2098)
(chunk top-up-2098) · **Parent:** #1209

This is the written record for the one module that entered
`worker/deno/lib/` under #2098:
...
claimed by **top-up-2098**, and this file is the reading of it.
...
No finding. The one deliberate asymmetry is that unknown nested keys warn
while a malformed `enabled` throws: a stray key cannot make the worker
behave differently from what the operator sees, and a mistyped switch can.
