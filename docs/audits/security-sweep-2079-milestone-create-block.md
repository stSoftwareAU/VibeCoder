...
**Issue:** [#2079](https://github.com/stSoftwareAU/VibeCoder/issues/2079)
(chunk top-up-2079) · **Parent:** #1209
...
touches no filesystem, and holds one process-lifetime `Set` of repository
slugs so a run attempts the repair at most once per repository.
