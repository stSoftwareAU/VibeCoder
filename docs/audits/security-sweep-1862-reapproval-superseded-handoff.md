...
**Issue:** [#1862](https://github.com/stSoftwareAU/VibeCoder/issues/1862) (chunk
top-up-1862) · **Parent:** #1209
...
own record documents. The module is claimed by **top-up-1862**, and this file is
the reading of it.
...
interpolates **GitHub-supplied metadata** into that comment, so the shapes below
are 12c's untrusted-ingestion shapes and the comment-authoring shapes together.
