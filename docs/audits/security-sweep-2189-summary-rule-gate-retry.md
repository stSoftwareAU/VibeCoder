...
**Issue:** [#2189](https://github.com/stSoftwareAU/VibeCoder/issues/2189) (chunk
top-up-2189) · **Parent:** #1209
...
| `issueNumber`     | the claim the run already holds                                                                                                                                                                                           | validated as a positive integer, then interpolated into prompt text and a summary path _string_. No filesystem call is made with it here                                                                                                                                                                                   |
