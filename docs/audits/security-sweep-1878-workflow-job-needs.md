...
**Issue:** [#1878](https://github.com/stSoftwareAU/VibeCoder/issues/1878) (chunk
12ad) · **Parent:** #1209
...
**aggregator** — a job whose `needs:` (transitively) reaches another job that is
also red on the same head? Its whole input is a target repository's
