...
**Issue:** [#2070](https://github.com/stSoftwareAU/VibeCoder/issues/2070) (chunk
top-up-2070, with #2071–#2073) · **Parent:** #1209
...
- **The manifest is trusted input**, as recorded under top-up-1956: the command
  adds no trust boundary and removes none.
