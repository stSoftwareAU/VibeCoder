...
| [Getting the most out of Opus 5.5](https://claude.dev/blog/getting-the-most-out-of-opus-5-5/) | 11 of its 15 tips are already covered. Two gaps remain: a running checklist so progress survives summarisation, and a design anti-pattern list for front-end work. "Typing mid-run" has no surface to change here. The `/fast` toggle was considered and declined, because the worker runs unattended and quality and token spend matter more than speed | [#2635](https://github.com/stSoftwareAU/VibeCoder/issues/2635), [#2636](https://github.com/stSoftwareAU/VibeCoder/issues/2636) |
