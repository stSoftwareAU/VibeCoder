...
| FLEET health directory           | `fleet_health_dir`                 | _(empty)_  | Directory for FLEET health tracking repository (Issue #535). When set, the worker reports health status after work                                                                                     |
