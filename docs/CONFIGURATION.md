...
This key is the configuration surface (Issue #2098). As of Issue #2561 it is
live for all six phases that accept a bundle — the **issue**, **planning**
and **question** runs (Issue #2102), the **PR feedback** and **CI fix**
runs (Issue #2103) and the **grill-me** rounds (Issue #2561): each collects a
...
repository it works on. Six builders accept a bundle (Issue #2101) —
**issue**, **planning**, **question**, **PR feedback**, **CI fix** and
**grill-me** — and all six collect one (Issues #2102, #2103 and #2561). The
query is the issue title and body on the four issue-shaped runs; on the two PR runs it is the PR title
