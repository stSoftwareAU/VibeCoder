...
|                             | [console_style.ts](../worker/deno/lib/console_style.ts)                                                           | The one `ℹ`/`✓`/`⚠`/`✗` glyph-and-colour pairing the setup surfaces print through, plus the bracketed-default helper (Issue #870)                                                     |
