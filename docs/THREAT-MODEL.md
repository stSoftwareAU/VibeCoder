...
| **C18** | Dependency release-age quarantine, verified against the registry (npm, JSR, crates.io) and fail-closed on what it cannot read | `worker/deno/lib/npm_package_age.ts`, `worker/deno/lib/bump_age_audit.ts`, `worker/deno/lib/bump_diff_cargo.ts`, `worker/deno/lib/crates_io_age.ts` | `worker/deno/tests/npm_package_age_test.ts`, `worker/deno/tests/bump_age_audit_test.ts`, `worker/deno/tests/bump_diff_cargo_test.ts`, `worker/deno/tests/crates_io_age_test.ts` |
