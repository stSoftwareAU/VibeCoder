...
- **Unit-suite classification** (checks 12–13) — unit tests that mutate
  ...
  check 12; files on the integration-test manifest are excluded from
  both. Each is reported as a single finding listing the affected files,
