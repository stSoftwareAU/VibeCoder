...
const STOP_WORDS: ReadonlySet<string> = new Set([
  "a", "about", "all", "also", "am", "an", "and", "any", "anything",
  "are", "as", "at", "be", "been", "before", "being", "but", "by",
  "can", "cannot", "do", "does", "each", "either", "else", "even",
  "ever", "every", "for", "from", "had", "has", "have", "here",
  "how", "i", "if", "in", "into", "is", "it", "its", "just", "may",
  "me", "might", "must", "my", "never", "no", "not", "of", "on",
  "only", "or", "other", "our", "out", "own", "rather", "really",
  "should", "so", "some", "such", "than", "that", "the", "their",
  "them", "then", "there", "these", "they", "this", "those", "to",
  "up", "us", "very", "via", "was", "we", "were", "what", "when",
  "which", "while", "who", "whose", "will", "with", "within", "would",
  "you", "your",
]);
