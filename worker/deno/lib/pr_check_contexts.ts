 ...
 *
 * Exported so `gitleaks_drift_scanner.ts` can ask the same question of a
 * caller's jobs without duplicating the parsing (Issue #2522).
 */
export function calledWorkflowPath(definition: unknown): string | null {
