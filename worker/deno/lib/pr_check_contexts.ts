...
export const EXEMPT_CONTEXTS: readonly ExemptContext[] = [
  ...
  },
  {
    ...
    reason:
      ...
      "cost #907 took out of the gate. The PowerShell suites are the " +
      "exception and no longer run here: the image provisions their " +
      "interpreter, so the `run.ps1` three moved into the required shards " +
      "(Issue #1598) and the `setup.ps1` two followed (Issue #1656). " +
