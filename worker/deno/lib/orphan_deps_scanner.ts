...
// Lives in `jsonc.ts` so a module that only reads a manifest need not import
// this scanner's dependency graph (Issue #974). Re-exported here because the
// scanner's own callers and tests import it from this module.
export { stripJsonc };
