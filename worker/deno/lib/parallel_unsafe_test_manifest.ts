...
export const PROCESS_STATE_MUTATOR_TEST_FILES: readonly string[] = [
  ...
  "tests/github_primary_quota_latch_test.ts",
  ...
  "tests/pr_ci_processor_jenkins_access_test.ts",
  "tests/pr_ci_processor_lock_test.ts",
  "tests/pr_ci_processor_milestones_test.ts",
  "tests/pr_ci_processor_moved_head_test.ts",
  "tests/pr_ci_processor_no_changes_test.ts",
  "tests/pr_ci_processor_test.ts",
  "tests/pr_failure_actions_test.ts",
  "tests/pr_feedback_processor_escape_hatch_test.ts",
  "tests/pr_feedback_processor_no_changes_test.ts",
  "tests/pr_feedback_processor_self_push_test.ts",
  ...
  "tests/worker_checkout_update_test.ts",
