...
export const REMOVED_CONFIG_KEYS: ReadonlyMap<string, string> = new Map([
  ...
  [
    "author_source",
    "The trust-source switch was removed (Issue #1066): there is now exactly " +
    "one source — the write/maintain/admin collaborators of each monitored " +
    "repo, minus the Vibe Coder logins and bots. Remove the key; nothing " +
    "replaces it. `./setup.sh` strips it for you.",
  ],
]);
