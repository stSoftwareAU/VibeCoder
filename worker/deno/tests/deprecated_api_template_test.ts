...
Deno.test("assembleDeprecatedApiPrompt - open issue titles are substituted", () => {
  const out = assembleDeprecatedApiPrompt(
    "Already open:\n{{OPEN_ISSUE_TITLES}}",
    {
      suppressedIds: [],
      knownOpenFindingIds: [],
...
Deno.test("assembleDeprecatedApiPrompt - an empty open-issue list renders (none)", () => {
  const out = assembleDeprecatedApiPrompt(
    "Already open:\n{{OPEN_ISSUE_TITLES}}",
    {
      suppressedIds: [],
