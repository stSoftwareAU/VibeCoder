...
const PROCESS_STATE_MUTATORS: ReadonlySet<string> = new Set([
  ...
  "create_all_idle_task_wrappers_command_test.ts",
  "create_all_idle_task_wrappers_test.ts",
  ...
  "idle_task_body_preview_limit_test.ts",
  ...
  "raise_all_idle_tasks_command_test.ts",
  "raise_all_idle_tasks_test.ts",
  "raise_boy_scout_idle_tasks_command_test.ts",
  "raise_single_idle_task_test.ts",
