...
**CRITICAL — Unattended Operation:** These machines run unattended
...
2. Open a single follow-up issue in the relevant repository capturing the
   ...
   silently stripped by the `label_security` check — applying it
   is wasted effort. Keep "mention `needs-human`" as wording in
