...
This scan is **deterministic and native** — a dedicated native scanner
performs the detection; no LLM judgement is involved in the core check. It is
