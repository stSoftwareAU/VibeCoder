...
## Plan Adjudication — Two Candidate Plans, One Verdict (Issue #4110)
...
- The content between the tags must be valid JSON — no trailing commas, no comments, no prose inside or after the closing tag. Put any narration *before* the block.
