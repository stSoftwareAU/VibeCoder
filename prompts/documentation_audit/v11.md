# Documentation Audit — Unify Learnings, Prune Stale Docs (v11)
...
```
   ...
   `<attribution_footer>` in the **Inputs** section, backticks and emoji intact.
   The footer shown in the skeleton is an example rendering; substitute the
   literal line you were given.
